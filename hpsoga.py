...
def run_hpsoga(pso_params, ga_params, eval_func, n_particles_part,
    ...
    """
    first run_pso then split population in sub-partitions and apply the crossover in each one
    """
    population = None
    global_best = None
    ...
    for _ in range(max_iters):
        ...
        population, _, _ = pso.run_pso(
            ...
            max_iters=pso_params['max_iters_pso'],
            pop_size=pso_params['pop_size_pso'],
        ...
        selected_pop = ga.roulette_selection(population, pso_params['pop_size_pso'],
